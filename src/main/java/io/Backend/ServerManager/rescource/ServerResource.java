package io.Backend.ServerManager.rescource;

import io.Backend.ServerManager.enumeration.Status;
import io.Backend.ServerManager.service.implementation.ServerServiceImplementation;
import io.Backend.ServerManager.model.Response;
...
@GetMapping("/list")
    ...
    public byte[] getServerImage(@PathVariable("fileName") String fileName) throws IOException {
        return Files.readAllBytes(Paths.get(System.getProperty("user.home") + "IdeaProjects/ServerManager/ServerManager/images/" + fileName));
    }
}
